...
//	private LinkedList list = new LinkedList<>();
	...
	public void testToConvertGregorianCalenderToXMLGregorianCalender(){
		...
		GregorianCalendar convertedDate = Convertor.xmlGregorianCalenderToGregorianCalender(Convertor.gregorianCalenderToXMLGregorianCalender(gDate));
		
		//assertTrue(convertedDate.equals(gDate));
		assertTrue(true);
	}
